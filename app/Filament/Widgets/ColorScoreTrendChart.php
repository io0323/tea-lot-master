...
class ColorScoreTrendChart extends ChartWidget
{
    protected static ?string $heading = '日別 色スコア推移';
    ...
    protected function getData(): array
    {
        ...
        $barColors = $this->getBarColors($data->pluck('avg_color')->toArray(), 'color_score');
        ...
        return [
            ...
            'datasets' => [
                [
                    'label' => '平均色スコア',
                    'data' => $data->pluck('avg_color')->map(fn($v) => round($v, 1))->toArray(),
    ...
    private function getFilteredData()
    {
        ...
        return $query
            ->selectRaw('inspected_at, AVG(color_score) as avg_color')
